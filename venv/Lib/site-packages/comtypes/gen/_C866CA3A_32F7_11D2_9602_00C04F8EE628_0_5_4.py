...
__all__ = [
    'DISPID_SPPsCount', 'SREStateChange', 'SPAR_Medium',
    'SPLEXICONTYPE', 'SVESentenceBoundary', 'DISPID_SWFEExtraData',
    'SpeechPropertyResourceUsage', 'DISPID_SRState',
    'SpeechVoicePriority', 'SPPHRASEREPLACEMENT', 'SPWORDLIST',
    'ISpPhrase', 'SVSFParseSapi', 'SPFM_OPEN_READONLY',
    'DISPID_SGRAddState', 'DISPID_SRGCmdLoadFromMemory', 'SPXRO_SML',
    'DISPID_SpeechCustomStream', 'DISPID_SVVoice',
    'DISPID_SOTGetAttribute', 'SVP_16', 'SECFIgnoreCase',
    'ISpeechVoice', 'SVEPhoneme', 'DISPID_SPRs_NewEnum',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPIElements', 'SP_VISEME_21',
    'SPBO_NONE', 'SPPS_RESERVED1', 'SRSActiveAlways',
    'DISPID_SOTRemove', 'SpShortcut', 'DISPID_SPIAudioStreamPosition',
    'ISpRecognizer3', 'ISpeechRecognizerStatus',
    'SAFTCCITT_uLaw_22kHzStereo', 'SVP_7', 'SP_VISEME_8',
    'SP_VISEME_13', 'SDA_No_Trailing_Space',
    'DISPID_SLGetPronunciations', 'SDKLDefaultLocation',
    'SpeechAudioFormatType', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPPBRestorePhraseFromMemory', 'eLEXTYPE_PRIVATE19',
    'DISPID_SGRSTWeight', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRSAudioStatus', 'DISPID_SRRAlternates',
    'DISPID_SDKCreateKey', 'DISPID_SpeechPhraseReplacements',
    'ISpResourceManager', 'ISpeechRecoResult', 'SAFT16kHz8BitStereo',
    'IInternetSecurityMgrSite', 'SPPS_Noun', 'ISpRecognizer2',
    'SPSHORTCUTPAIR', 'SRCS_Disabled', 'SPINTERFERENCE_TOOSLOW',
    'SPDATAKEYLOCATION', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SBONone', 'SRARoot', 'DISPID_SPEAudioTimeOffset',
    'SpeechPropertyResponseSpeed', 'eLEXTYPE_PRIVATE12',
    'SECFIgnoreWidth', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFTCCITT_uLaw_11kHzMono', 'SpeechGrammarState', 'LONG_PTR',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRRGetXMLResult', 'DISPID_SGRsItem',
    'SLTApp', 'SAFT11kHz8BitStereo', 'ISpObjectToken',
    'SAFT44kHz8BitStereo', 'DISPID_SRGCommit',
    'DISPID_SGRInitialState', 'DISPID_SLGenerationId', 'DISPIDSPRG',
    'DISPID_SLGetWords', 'SRSInactiveWithPurge', 'SRAONone',
    'DISPID_SPACommit', 'SPEI_SENTENCE_BOUNDARY', 'SPEI_VOICE_CHANGE',
    'DISPID_SGRsDynamic', 'SP_VISEME_12', 'SVSFPersistXML', 'SpVoice',
    'DISPID_SLWs_NewEnum', 'SRCS_Enabled',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT22kHz8BitStereo',
    'eLEXTYPE_PRIVATE20', 'SPRST_ACTIVE', 'SVEViseme',
    'SPAO_RETAIN_AUDIO', 'eWORDTYPE_DELETED', 'ISpeechPhraseInfo',
    'eLEXTYPE_PRIVATE6', 'SRERequestUI', 'SPTEXTSELECTIONINFO',
    'SPADAPTATIONRELEVANCE', 'SPEI_VISEME', 'DISPID_SPEDisplayText',
    'DISPID_SPPParent', 'DISPID_SRCEEnginePrivate', 'SPGRAMMARSTATE',
    'SDA_Two_Trailing_Spaces', 'SAFTCCITT_ALaw_44kHzMono',
    'SREPrivate', 'eLEXTYPE_PRIVATE17', 'SPPS_Noncontent',
    'SpMMAudioEnum', 'SpeechVoiceCategoryTTSRate', 'DISPID_SLPType',
    'SPEI_SR_BOOKMARK', 'SPSLMA', 'ISpeechPhraseRules',
    'ISpObjectTokenCategory', 'SPEI_END_INPUT_STREAM',
    'SPRST_NUM_STATES', 'SPAUDIOOPTIONS', 'SpMMAudioOut',
    'SpeechVoiceEvents', 'eLEXTYPE_PRIVATE10', 'ISpeechAudioFormat',
    'SSFMCreate', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SRESoundEnd',
    'SAFTADPCM_22kHzStereo', 'DISPID_SVSVisemeId', 'DISPID_SPIRule',
    'DISPID_SpeechGrammarRules', 'SpPhraseInfoBuilder',
    'DISPID_SMSGetData', 'SPRS_ACTIVE', 'DISPID_SGRSTText',
    'SPSHT_OTHER', 'SAFT8kHz16BitMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFT11kHz8BitMono', 'SpObjectTokenCategory',
    ...
    'SpeechVisemeType', 'eLEXTYPE_RESERVED4', 'SPEI_START_SR_STREAM',
    'SpeechTokenShellFolder', 'tagSPTEXTSELECTIONINFO', 'ISpVoice',
    'DISPID_SVPause', 'DISPID_SPPConfidence', 'SPEI_SOUND_END',
    'SREStreamStart', 'ISpeechAudioStatus', 'SVSFParseAutodetect',
    'DISPID_SPISaveToMemory', 'SAFT44kHz8BitMono',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRCSetAdaptationData',
    'SP_VISEME_20', 'STSF_CommonAppData',
    'SpeechSpecialTransitionType', 'DISPID_SRRSaveToMemory',
    'DISPID_SOTsCount', 'SPAS_RUN', 'DISPID_SVAlertBoundary',
    'ISpeechBaseStream', 'DISPID_SRGReset', 'SLOStatic',
    'DISPID_SPIReplacements', 'SPCONTEXTSTATE',
    'SPWORDPRONUNCIATIONLIST', 'SPDKL_DefaultLocation',
    'SVSFUnusedFlags', 'SpFileStream', 'SPRECORESULTTIMES',
    'DISPID_SAFSetWaveFormatEx', 'ISpEventSink',
    'DISPID_SPIProperties', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRGetFormat', 'DISPID_SpeechRecoContext', 'SGRSTTRule',
    'SPAR_Unknown', 'ISpObjectWithToken',
    'SpeechCategoryRecoProfiles', 'ISpeechFileStream', 'SPPHRASE',
    'DISPID_SLPs_NewEnum', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPEPronunciation', 'SVP_0', 'SPBINARYGRAMMAR',
    'DISPID_SpeechVoice', 'DISPID_SOTCreateInstance',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SOTId', 'SpStream', 'SREAdaptation', 'SPVOICESTATUS',
    'SpeechCategoryPhoneConverters', 'ISpPhoneticAlphabetSelection',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SRCEFalseRecognition',
    'SPAUDIOSTATUS', 'SPWT_LEXICAL', 'DISPID_SBSSeek',
    'SVSFParseSsml', 'DISPID_SPAStartElementInResult',
    'ISpRecoGrammar2', 'DISPID_SASCurrentDevicePosition',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRRSpeakAudio', 'SPEVENTENUM',
    'SpMMAudioIn', 'DISPID_SOTsItem', 'DISPID_SPRDisplayAttributes',
    'SRADefaultToActive', 'SAFTADPCM_22kHzMono', 'SVP_21',
    'Speech_Default_Weight', 'DISPID_SLPsItem',
    'DISPID_SPEEngineConfidence', 'SAFT32kHz8BitStereo',
    '_ISpeechVoiceEvents', 'ISpNotifySink', 'SDTDisplayText',
    'STCRemoteServer', 'ISpPhoneConverter', 'SECLowConfidence',
    'SPEI_MIN_SR', 'DISPID_SGRSTsItem', 'DISPID_SVEVoiceChange',
    'SITooQuiet', 'ISpeechObjectTokenCategory', 'SVSFNLPMask',
    'Speech_Max_Word_Length', 'SPEI_TTS_PRIVATE',
    'SPINTERFERENCE_NOSIGNAL', 'SECFEmulateResult',
    'DISPID_SOTCGetDataKey', 'SpeechMicTraining',
    'DISPID_SPIGetDisplayAttributes', 'SVP_15',
    'DISPID_SpeechLexicon', 'SAFTNonStandardFormat',
    'DISPID_SWFEFormatTag', 'SASStop', 'UINT_PTR', 'SpPhoneConverter',
    'SPINTERFERENCE_TOOQUIET', 'SpeechRecoContextState',
    'DISPID_SVSInputWordLength', 'DISPID_SpeechAudioFormat',
    'SP_VISEME_4', 'SPPS_RESERVED4', 'SPVISEMES',
    'SpeechTokenContext', 'SAFT12kHz8BitMono', 'SRAExport',
    'SpNullPhoneConverter', 'ISpeechLexiconPronunciations',
    'DISPID_SRGCmdSetRuleState', 'tagSPPROPERTYINFO',
    'DISPID_SRCERecognizerStateChange', 'eLEXTYPE_RESERVED7',
    'SPVPRIORITY', 'DISPID_SpeechAudioBufferInfo', 'SRTEmulated',
    'SREInterference', 'SRERecoOtherContext', 'DISPID_SRStatus',
    'SAFT11kHz16BitMono', 'SPGS_ENABLED', 'SPEI_PHRASE_START',
    'SPFM_CREATE_ALWAYS', 'SREAllEvents',
    'SpeechPropertyComplexResponseSpeed', 'DISPIDSPTSI_ActiveOffset',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVSFPurgeBeforeSpeak', 'SVP_8',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SVWaitUntilDone',
    'SPEI_RESERVED1', 'DISPID_SLWsItem', 'SVP_3',
    'DISPID_SPRuleParent', 'DISPID_SPRules_NewEnum',
    'SpeechRecognizerState', 'DISPID_SRGetPropertyNumber',
    'SVEVoiceChange', 'Speech_StreamPos_RealTime',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPCT_COMMAND',
    'DISPID_SPERetainedSizeBytes', 'SpSharedRecoContext',
    'SpWaveFormatEx', 'SpeechBookmarkOptions', 'SREHypothesis',
    'SPBO_AHEAD', 'SAFTGSM610_8kHzMono', 'SAFT22kHz16BitStereo',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SLWLangId', 'SPFILEMODE',
    'SVEEndInputStream', 'SPINTERFERENCE_TOOLOUD', 'SpCustomStream',
    'DISPID_SOTSetId', 'DISPID_SOTGetStorageFileName',
    'SAFT24kHz16BitMono', 'DISPID_SPIStartTime',
    'SWPUnknownWordUnpronounceable', 'SAFTADPCM_44kHzStereo',
    'DISPID_SVSInputSentenceLength', 'DISPID_SDKSetBinaryValue',
    'SpeechTokenKeyUI', 'SPPS_Unknown', 'SPRECOGNIZERSTATUS',
    'DISPID_SRRTLength', 'DISPID_SVGetAudioInputs',
    'SPPS_NotOverriden', 'DISPID_SRCResume', 'SPFM_OPEN_READWRITE',
    'eLEXTYPE_PRIVATE3', 'DISPID_SFSOpen', 'DISPID_SpeechFileStream',
    'SWPKnownWordPronounceable', 'SITooSlow', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechRecoResult', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISpeechGrammarRule', 'DISPID_SPPValue', 'SAFT22kHz8BitMono',
    'SGDSActiveWithAutoPause', 'SP_VISEME_1', 'DISPID_SAFGuid',
    'SpeechTokenKeyFiles', 'DISPID_SPRText',
    'SPRST_INACTIVE_WITH_PURGE', 'SPAR_Low', 'SpeechGrammarWordType',
    'DISPID_SGRId', 'ISpeechAudio', 'SPPS_Interjection',
    'DISPID_SVEStreamStart', 'SPSVerb', 'DISPID_SRCEStartStream',
    'SRERecognition', 'DISPID_SMSADeviceId', 'SpeechAudioProperties',
    'SWTDeleted', 'SpInprocRecognizer', 'DISPID_SPIEngineId',
    'SPEI_RECO_OTHER_CONTEXT', 'SPEI_MAX_SR', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRProfile', 'SPEI_WORD_BOUNDARY',
    'DISPID_SPIAudioSizeTime', 'SVP_4', 'SVSFIsXML',
    'eLEXTYPE_PRIVATE14', 'SAFT44kHz16BitMono',
    'DISPID_SVEventInterests', 'DISPID_SPERequiredConfidence',
    'DISPID_SAFType', 'ISpStreamFormatConverter', 'DISPID_SVPriority',
    'DISPID_SpeechRecoResult2', 'SDTAll', 'SpeechCategoryAppLexicons',
    'SRTStandard', 'SPLOADOPTIONS', 'DISPID_SGRAddResource',
    'DISPID_SABIEventBias', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPEsCount', 'SPLO_STATIC',
    'SP_VISEME_6', 'SVSFIsNotXML', 'SpeechCategoryRecognizers',
    'DISPIDSPTSI_ActiveLength', 'SPGS_EXCLUSIVE',
    'ISpNotifyTranslator', 'SpMemoryStream', 'SAFTADPCM_44kHzMono',
    'SPCT_SLEEP', 'SPEI_MAX_TTS', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechPropertyNormalConfidenceThreshold', 'SPVPRI_NORMAL',
    'SPRULESTATE', 'SVP_11', 'SPXRO_Alternates_SML',
    'DISPID_SLPPhoneIds', 'SGSEnabled', 'SpeechLoadOption',
    'DISPID_SWFESamplesPerSec', 'SpeechTokenIdUserLexicon',
    'DISPID_SRGId', 'eLEXTYPE_MORPHOLOGY', 'SPSUnknown',
    'DISPID_SASFreeBufferSpace', 'SPSHORTCUTPAIRLIST', 'SDTAudio',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SVGetProfiles',
    'DISPID_SPCIdToPhone', 'STSF_FlagCreate', 'SRTExtendableParse',
    'SPPHRASERULE', 'ISpeechCustomStream', 'SECFDefault',
    'DISPID_SPEDisplayAttributes', 'eLEXTYPE_PRIVATE7',
    'DISPID_SpeechObjectToken', 'DISPID_SRSClsidEngine',
    'SpeechAllElements', 'ISpeechPhraseElement', 'SRSEDone',
    'DISPID_SRSetPropertyString',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SP_VISEME_9',
    'DISPID_SASCurrentSeekPosition', 'ISpEventSource',
    'ISpeechRecognizer', 'SPPS_Verb', 'SpeechAudioFormatGUIDWave',
    'DISPID_SVSRunningState', 'ISequentialStream',
    'DISPID_SVDisplayUI', 'SREAudioLevel', 'DISPID_SDKGetlongValue',
    'SPRECOSTATE', 'DISPID_SRRSetTextFeedback', 'DISPID_SOTDataKey',
    'DISPID_SRCESoundStart',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SVF_Stressed',
    'ISpeechRecoResultDispatch', 'SP_VISEME_18',
    'SAFT8kHz16BitStereo', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SGRsCommitAndSave', 'DISPID_SRRPhraseInfo', 'ISpLexicon',
    'DISPID_SOTGetDescription', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SRGIsPronounceable', 'eLEXTYPE_APP', 'SSFMOpenReadWrite',
    'SpInProcRecoContext', 'DISPID_SOTDisplayUI', 'SFTInput',
    'SRATopLevel', 'DISPID_SASState', 'SpSharedRecognizer',
    'DISPID_SGRAttributes', 'SpeechStreamSeekPositionType',
    'ISpStreamFormat', 'ISpRecoContext', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SpeechPhraseInfo', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRGetRecognizers', 'DISPID_SRDisplayUI',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVEAllEvents',
    'ISpeechGrammarRules', 'SGRSTTEpsilon', 'SREStreamEnd',
    'DISPID_SWFEBitsPerSample', 'ISpeechGrammarRuleState',
    'DISPID_SpeechAudio', 'SDA_One_Trailing_Space', 'SVP_1',
    'DISPID_SRCVoicePurgeEvent', 'SpeechUserTraining',
    'SAFTADPCM_11kHzStereo', 'ISpeechObjectTokens', 'SPRULE',
    'ISpeechResourceLoader', 'DISPID_SRGCmdLoadFromFile',
    'SpeechGrammarTagUnlimitedDictation', 'SPINTERFERENCE_NOISE',
    'DISPID_SPRuleName', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPELexicalForm', 'SDTReplacement',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SLPSymbolic',
    'SAFTADPCM_11kHzMono', 'SPEI_RECOGNITION',
    'DISPID_SPPEngineConfidence', 'DISPID_SABIMinNotification',
    'SVSFParseMask', 'SPSEMANTICERRORINFO', 'SPWF_SRENGINE',
    'DISPID_SpeechRecognizerStatus', 'ISpeechRecoResult2', 'SVP_5',
    'eLEXTYPE_PRIVATE2', 'SASPause', 'SPSTREAMFORMATTYPE',
    'eLEXTYPE_PRIVATE4', 'SpeechVoiceSkipTypeSentence',
    'SpResourceManager', 'SVF_None', 'DISPID_SpeechVoiceStatus',
    'SPEI_RESERVED5', 'DISPID_SRRAudio', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPPChildren', 'SPWT_DISPLAY', 'WAVEFORMATEX',
    'SpeechPartOfSpeech', 'SPPS_SuppressWord', 'eLEXTYPE_RESERVED8',
    'SAFT24kHz16BitStereo', 'SAFT48kHz8BitStereo', 'STCAll',
    'SpeechEmulationCompareFlags', 'DISPID_SRGSetTextSelection',
    'DISPID_SGRsCount', 'SVP_12', 'SpeechRecoProfileProperties',
    'SPINTERFERENCE_NONE', 'SPDKL_LocalMachine', 'SPEI_RESERVED3',
    'DISPID_SVGetVoices', 'SP_VISEME_5', 'ISpeechPhraseProperty',
    'DISPID_SRCRequestedUIType', 'SpeechCategoryAudioOut',
    'SVEStartInputStream', 'SPRS_ACTIVE_USER_DELIMITED',
    'SDTAlternates', 'DISPID_SGRName', 'SINone', 'SPFM_CREATE',
    'SPEI_PHONEME', 'DISPID_SDKGetBinaryValue',
    'SAFT32kHz16BitStereo', 'DISPID_SPPsItem', 'DISPID_SRCBookmark',
    'SP_VISEME_3', 'SpeechRunState', 'SSFMCreateForWrite',
    'SAFT8kHz8BitStereo', 'DISPID_SOTIsUISupported',
    'DISPID_SRCVoice', 'Speech_Max_Pron_Length',
    'DISPID_SpeechPhraseRules', 'DISPID_SpeechVoiceEvent',
    'SpeechWordType', 'SpeechGrammarTagWildcard',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SOTCId', 'ISpeechPhoneConverter', 'SPAUDIOBUFFERINFO',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVSLastResult',
    'DISPID_SpeechRecognizer', 'SGRSTTWord', 'eLEXTYPE_RESERVED10',
    'DISPID_SOTCSetId', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpeechCategoryVoices', 'ISpeechPhraseReplacements',
    'SDTProperty', 'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPRulesItem',
    'SSSPTRelativeToEnd', 'SPSMF_UPS', 'DISPID_SDKDeleteKey',
    'SRAInterpreter', 'DISPID_SWFEBlockAlign', 'SITooFast',
    'SAFT11kHz16BitStereo', 'DISPID_SPRuleChildren',
    'SAFTADPCM_8kHzStereo', 'ISpDataKey', 'SPWORD',
    'DISPID_SPRuleNumberOfElements',
    'DISPID_SRSCurrentStreamPosition', 'SP_VISEME_16',
    'DISPID_SLPsCount', 'DISPID_SLWType', 'SVP_18',
    'DISPID_SPILanguageId', 'DISPID_SPIRetainedSizeBytes',
    'SGLexical', 'DISPID_SRCERequestUI', 'DISPID_SVVolume',
    'DISPID_SPPName', 'DISPID_SPEActualConfidence',
    'SpeechRetainedAudioOptions', 'SDTLexicalForm', 'SFTSREngine',
    'DISPID_SPRuleConfidence', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SDKSetStringValue', 'SAFT32kHz16BitMono',
    'SAFTADPCM_8kHzMono', 'DISPID_SABufferInfo', 'DISPID_SVEBookmark',
    'ISpAudio', 'SPEI_END_SR_STREAM', 'eLEXTYPE_LETTERTOSOUND',
    'SGLexicalNoSpecialChars', 'DISPID_SRCEAdaptation', 'SPSModifier',
    'DISPID_SOTs_NewEnum', 'DISPID_SFSClose',
    'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SGRSAddWordTransition', 'ISpeechObjectToken',
    'DISPID_SVEStreamEnd', 'ISpeechRecoGrammar', 'SPAO_NONE',
    'SVPNormal', 'SVF_Emphasis', 'eLEXTYPE_PRIVATE15', 'SGDSActive',
    'DISPID_SVEEnginePrivate', 'SPEVENTSOURCEINFO',
    'SREFalseRecognition', 'SPCS_DISABLED',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechRecoResultTimes',
    'IEnumSpObjectTokens', 'SPAS_STOP', 'SPEI_SOUND_START',
    'DISPID_SGRSTsCount', 'DISPID_SOTCategory', 'SPCATEGORYTYPE',
    'SAFT12kHz8BitStereo', 'DISPID_SPRulesCount', 'SpObjectToken',
    ...
    'SGSDisabled', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SPIAudioSizeBytes', 'IStream', 'ISpGrammarBuilder',
    'SDKLCurrentConfig', 'SpNotifyTranslator', 'DISPID_SVResume',
    'DISPID_SBSWrite', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SDKSetLongValue', 'SREBookmark',
    'SGDSActiveUserDelimited', 'DISPID_SpeechPhraseElements',
    'DISPID_SGRSTransitions', 'SECHighConfidence', 'SPSNotOverriden',
    'DISPID_SpeechMMSysAudio', 'SINoise', 'DISPID_SMSAMMHandle',
    'SSSPTRelativeToStart', 'SVPAlert', 'DISPID_SCSBaseStream',
    'DISPID_SLPLangId', 'ISpeechLexicon', 'DISPIDSPTSI',
    'DISPID_SOTMatchesAttributes', 'ISpeechLexiconWord',
    'DISPID_SVEViseme', 'SpeechRuleState',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SLPPartOfSpeech',
    'eLEXTYPE_PRIVATE13', 'DISPID_SDKGetStringValue',
    'SRAORetainAudio', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRCEBookmark', 'DISPID_SGRsCommit', 'ISpXMLRecoResult',
    'SVPOver', 'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRIsShared',
    'DISPID_SOTCEnumerateTokens', 'SVP_6', 'DISPID_SRCCreateGrammar',
    'DISPID_SRCEEndStream', 'DISPID_SGRSTRule', 'SGRSTTTextBuffer',
    'SVEAudioLevel', 'DISPID_SPCPhoneToId', 'ISpeechPhraseProperties',
    'SGPronounciation', 'ISpNotifySource',
    'DISPID_SVAudioOutputStream', '_RemotableHandle',
    'DISPID_SPRFirstElement', 'SPEI_TTS_BOOKMARK', 'SPPS_LMA',
    'SPGRAMMARWORDTYPE', 'DISPID_SLAddPronunciation', 'SVEBookmark',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPPId', 'DISPID_SRCPause',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVSFNLPSpeakPunc',
    'DISPID_SAVolume', 'DISPID_SVEWord', 'SpeechRegistryUserRoot',
    'SPDKL_CurrentConfig', 'DISPID_SGRsFindRule', 'DISPID_SPCLangId',
    'SAFTCCITT_uLaw_8kHzMono', 'eLEXTYPE_USER',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SASNonBlockingIO',
    'ISpeechPhraseReplacement', 'SAFT24kHz8BitMono',
    'SPSMF_SAPI_PROPERTIES', 'SVP_9', 'DISPID_SRGRules',
    'SPEI_TTS_AUDIO_LEVEL', 'SPBO_TIME_UNITS',
    'DISPID_SRGetPropertyString', 'SPEI_ADAPTATION',
    'eLEXTYPE_RESERVED9', 'SPEI_INTERFERENCE',
    'DISPID_SRCEventInterests', 'SPFM_NUM_MODES',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechAudioStatus', 'SpeechVisemeFeature',
    '_ISpeechRecoContextEvents', 'SP_VISEME_0', 'SPWF_INPUT',
    'SAFT22kHz16BitMono', 'SPEVENT', 'SpeechEngineProperties',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVEWordBoundary',
    'SPRECOCONTEXTSTATUS', 'SPSFunction', 'DISPID_SGRs_NewEnum',
    'SAFTGSM610_44kHzMono', 'DISPID_SGRSTNextState',
    'SpeechPropertyLowConfidenceThreshold', 'SAFT8kHz8BitMono',
    'ISpeechRecoResultTimes', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRCEAudioLevel', 'SPSEMANTICFORMAT', 'DISPID_SPRsItem',
    'DISPID_SLWsCount', 'DISPID_SPEs_NewEnum', 'SP_VISEME_2',
    'SAFT16kHz8BitMono', 'ISpeechPhraseInfoBuilder', 'SRADynamic',
    'SpeechAddRemoveWord', 'SpeechEngineConfidence', 'SVP_17',
    'SPAS_CLOSED', 'ISpSerializeState', 'DISPID_SABIBufferSize',
    'SWTAdded', 'SPXMLRESULTOPTIONS', 'SPEI_SR_PRIVATE',
    'ISpeechLexiconWords', 'SPRST_INACTIVE', 'SP_VISEME_7',
    'SPPHRASEPROPERTY', 'SPCT_DICTATION', 'DISPID_SVEAudioLevel',
    'DISPID_SDKDeleteValue', 'DISPID_SRCRetainedAudioFormat',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPEAudioSizeBytes', 'SGDisplay',
    'DISPID_SADefaultFormat', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SLWPronunciations', 'SREPropertyNumChange',
    'SVSFlagsAsync', 'SPPROPERTYINFO', 'SPWORDTYPE', 'SPSNoun',
    'SpeechTokenKeyAttributes', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SRAudioInputStream', 'SAFT12kHz16BitMono',
    'DISPID_SRGRecoContext', 'DISPID_SGRSTType',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SBSRead',
    'DISPID_SGRSTPropertyName', 'SP_VISEME_17', 'DISPID_SWFEChannels',
    'DISPID_SGRClear', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SGRSRule', 'SPGS_DISABLED', 'SSFMOpenForRead',
    'SAFTNoAssignedFormat', 'DISPID_SRCCreateResultFromMemory',
    'eLEXTYPE_VENDORLEXICON', 'eLEXTYPE_PRIVATE18',
    'DISPID_SpeechObjectTokens', 'SPAUDIOSTATE', 'SPPS_Function',
    'SP_VISEME_11', 'SpeechLexiconType', 'SPCT_SUB_DICTATION',
    'eLEXTYPE_RESERVED6', 'SGSExclusive', 'SPWT_PRONUNCIATION',
    'SpeechDataKeyLocation', 'SPRS_INACTIVE', 'DISPID_SPAs_NewEnum',
    'SPSHT_EMAIL', 'DISPID_SRCEPhraseStart',
    'SpeechAudioFormatGUIDText', 'SAFT32kHz8BitMono', 'ISpRecognizer',
    'DISPID_SVAudioOutput', 'SSTTDictation', 'DISPID_SOTCDefault',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRRAudioFormat',
    'DISPID_SVSInputWordPosition', 'SREPropertyStringChange',
    'SpeechGrammarTagDictation', 'ISpeechPhraseRule', 'SPVPRI_ALERT',
    'DISPID_SPIGrammarId', 'DISPID_SRRGetXMLErrorInfo',
    'SPINTERFERENCE', 'DISPID_SPEsItem', 'STCInprocHandler',
    'DISPID_SRCEPropertyStringChange', 'SRESoundStart',
    'SAFT24kHz8BitStereo', 'SAFTGSM610_22kHzMono',
    'SAFT48kHz8BitMono', 'DISPID_SDKEnumKeys', 'SSTTTextBuffer',
    'eLEXTYPE_PRIVATE11', 'SPSInterjection', 'ISpRecoResult',
    'SBOPause', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPPARTOFSPEECH', 'SVSFDefault',
    'SpeechDiscardType', 'SPPS_RESERVED2',
    ...
    'DISPID_SREmulateRecognition', 'DISPID_SAStatus',
    'DISPID_SpeechLexiconPronunciation', 'eLEXTYPE_PRIVATE16',
    'ISpeechMemoryStream', 'SITooLoud', 'SPSHORTCUTTYPE',
    'DISPID_SBSFormat', 'DISPID_SASetState',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRGState',
    'ISpRecoCategory', 'DISPID_SRRTimes',
    'DISPID_SpeechPhraseProperty', 'SpeechFormatType',
    'ISpRecoContext2', 'DISPID_SpeechDataKey', 'SPSERIALIZEDPHRASE',
    'DISPID_SPPNumberOfElements', 'ISpeechTextSelectionInformation',
    'SVP_10', 'DISPID_SpeechLexiconWord',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechLexiconPronunciation',
    'DISPID_SMSSetData', 'STCLocalServer', 'SAFT16kHz16BitMono',
    'ISpeechPhraseElements', 'SRTSMLTimeout', 'SRTReSent',
    'ISpeechMMSysAudio', 'DISPID_SRCEHypothesis', 'ISpeechDataKey',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPAsItem',
    'SPWORDPRONUNCIATION', 'ISpeechXMLRecoResult',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVP_20', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRGCmdSetRuleIdState', 'SPSSuppressWord',
    'SpeechAudioVolume', 'SAFTText', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SRGDictationLoad', 'SLTUser', 'SASRun',
    'SpTextSelectionInformation', 'DISPID_SVRate',
    'DISPID_SRRTStreamTime', 'SpLexicon', 'SVP_2',
    'SAFTCCITT_ALaw_22kHzMono', 'SDA_Consume_Leading_Spaces',
    'DISPID_SRCreateRecoContext', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPRNumberOfElements', 'Speech_StreamPos_Asap',
    'ISpPhraseAlt', 'SRTAutopause', 'DISPID_SAEventHandle',
    'SpCompressedLexicon', 'DISPID_SVEPhoneme',
    'SpeechRuleAttributes', '_SPAUDIOSTATE',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SLGetGenerationChange',
    'SVP_14', 'DISPID_SOTRemoveStorageFileName',
    'SpeechGrammarRuleStateTransitionType', 'STCInprocServer',
    'SPEI_RESERVED6', 'SVEPrivate', 'SPAS_PAUSE',
    'DISPID_SPEAudioSizeTime', 'SpPhoneticAlphabetConverter',
    'SpeechTokenValueCLSID', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SAFTGSM610_11kHzMono', 'SPSHT_NotOverriden',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SMSALineId', 'SPEI_REQUEST_UI',
    'SDKLCurrentUser', 'IInternetSecurityManager',
    'DISPID_SPIGetText', 'SpeechPropertyAdaptationOn',
    'DISPID_SpeechPhraseRule', 'SECFIgnoreKanaType',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPAR_High', 'ISpeechVoiceStatus',
    'SPPS_RESERVED3', 'SLODynamic', 'SPEI_MIN_TTS', 'ISpMMSysAudio',
    'DISPID_SPPFirstElement', 'DISPID_SRCERecognition',
    'DISPID_SVESentenceBoundary', 'SpeechDisplayAttributes',
    'DISPID_SVSkip', 'SECNormalConfidence', 'DISPID_SVIsUISupported',
    'DISPID_SRCERecognitionForOtherContext', 'SGDSInactive',
    'SPBOOKMARKOPTIONS', 'DISPID_SPAPhraseInfo',
    'DISPID_SVSPhonemeId', 'SPPHRASEELEMENT', 'SPSHT_Unknown',
    'SDTPronunciation', 'SRSInactive', 'SVSFIsFilename',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRAudioInput',
    'DISPID_SVStatus', 'SPVPRI_OVER', 'SpeechWordPronounceable',
    'SDTRule', 'ISpStream', 'DISPID_SpeechRecoContextEvents',
    'SpeechVoiceSpeakFlags', 'DISPID_SGRSTPropertyValue',
    'SPLO_DYNAMIC', 'SAFT16kHz16BitStereo', 'SpUnCompressedLexicon',
    'SPCT_SUB_COMMAND', 'DISPID_SLRemovePronunciation',
    'DISPID_SpeechPhraseElement', 'SpeechStreamFileMode',
    'SAFTCCITT_ALaw_8kHzStereo', 'SDKLLocalMachine',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SWPUnknownWordPronounceable', 'DISPID_SpeechLexiconWords',
    'DISPID_SDKEnumValues', 'SRSActive', 'SREPhraseStart',
    'DISPID_SPRuleFirstElement', 'SAFT48kHz16BitStereo',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechPhraseProperties',
    'ISpProperties', 'SP_VISEME_14', 'DISPID_SVSpeak', 'SVP_19',
    'SASClosed', 'SpStreamFormatConverter', 'SSTTWildcard',
    'ISpRecoGrammar', 'eWORDTYPE_ADDED', 'DISPID_SRIsUISupported',
    'SP_VISEME_19', 'DISPID_SVSyncronousSpeakTimeout',
    'STSF_LocalAppData', 'DISPID_SRGDictationUnload',
    'DISPID_SRRecognizer', 'STSF_AppData', 'SVP_13',
    'SpeechInterference', 'SpAudioFormat', 'SPEI_RESERVED2',
    'SRSEIsSpeaking', 'DISPID_SRCRecognizer', 'SPDKL_CurrentUser',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLWWord', 'DISPID_SPAsCount', 'DISPID_SPRuleId',
    'IEnumString', 'SVSFVoiceMask', 'SAFTDefault', 'SINoSignal',
    'SpeechRecoEvents', 'SAFT48kHz16BitMono',
    'DISPID_SpeechLexiconProns', 'tagSTATSTG', 'DISPID_SDKOpenKey',
    'SPWAVEFORMATTYPE', 'SGRSTTWildcard', 'DISPID_SABufferNotifySize',
    'DISPID_SVSpeakStream', 'SpeechAudioState',
    'DISPID_SRSetPropertyNumber', 'DISPID_SGRsAdd',
    'SpeechRecognitionType', 'SP_VISEME_10',
    'DISPID_SVGetAudioOutputs', 'DISPID_SpeechPhraseReplacement',
    'SAFT12kHz16BitStereo', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPPS_Modifier', 'DISPID_SGRSTs_NewEnum', 'SECFNoSpecialChars',
    'DISPID_SRCRetainedAudio', 'DISPID_SRRRecoContext',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPPs_NewEnum',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPARecoResult',
    'ISpeechWaveFormatEx', 'ISpPhoneticAlphabetConverter',
    'DISPID_SpeechMemoryStream', 'DISPID_SVSpeakCompleteEvent',
    'SPEI_UNDEFINED', 'ISpeechRecoContext', 'DISPID_SpeechBaseStream',
    'SPBO_PAUSE', 'SGRSTTDictation', 'DISPID_SPRsCount',
    'DISPID_SRRTTickCount', 'DISPID_SGRSTPropertyId',
    'DISPID_SPEAudioStreamOffset', 'ISpShortcut', 'SP_VISEME_15',
    'DISPID_SRCState', 'SPSERIALIZEDRESULT', 'DISPID_SRCESoundEnd'
]

_check_version('1.2.0', 1612203491.290509)
