...
__all__ = [
    ...
    'SpObjectToken', 'ISpPhrase', 'DISPID_SDKCreateKey',
    'SPCONTEXTSTATE', 'DISPID_SGRSTType', 'DISPID_SGRSTNextState',
    '_ISpeechRecoContextEvents',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SLGetPronunciations', 'ISpeechGrammarRuleState',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechRecognizer',
    'DISPID_SRGIsPronounceable', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SpeechAudioStatus', 'ISpNotifySink', 'SITooFast',
    'SPEI_START_SR_STREAM', 'ISpPhoneConverter', 'SVEViseme',
    'SAFT8kHz16BitStereo', 'ISpRecoCategory', 'SAFT12kHz16BitMono',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SLWsItem',
    'DISPID_SPIAudioStreamPosition', 'SPFILEMODE',
    'SAFT22kHz8BitMono', 'SSFMOpenReadWrite', 'SREAllEvents',
    'DISPID_SGRSTWeight', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SAFT16kHz16BitMono', 'SAFTADPCM_22kHzStereo',
    'SpeechRegistryUserRoot', 'SpPhoneticAlphabetConverter',
    'ISpeechLexicon', 'DISPID_SOTCreateInstance', 'SPPS_Noncontent',
    'SpeechTokenKeyAttributes', 'SpeechEmulationCompareFlags',
    'SP_VISEME_19', 'SP_VISEME_7', 'ISpeechPhraseRules',
    'SpAudioFormat', 'DISPID_SVStatus', 'DISPID_SGRsFindRule',
    'DISPID_SOTGetDescription',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpPhraseAlt',
    'SVSFParseSapi', 'DISPID_SLPPhoneIds', 'DISPID_SRGState',
    'SpeechTokenShellFolder', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPIProperties', 'SPEI_RESERVED5',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPRS_ACTIVE',
    'DISPID_SpeechVoice', 'eLEXTYPE_PRIVATE2', 'DISPIDSPTSI',
    'SPRECORESULTTIMES', 'SREBookmark', 'SpeechRuleState',
    'SPPS_RESERVED4', 'SRESoundEnd', 'DISPID_SOTGetStorageFileName',
    'eWORDTYPE_ADDED', 'DISPID_SOTCDefault', 'STCAll',
    'DISPID_SLGetGenerationChange', 'SpeechStreamFileMode',
    'DISPID_SAFSetWaveFormatEx', 'SRSEIsSpeaking', 'LONG_PTR',
    'DISPID_SPELexicalForm', 'SVP_7',
    'DISPID_SpeechLexiconPronunciation', 'SPFM_OPEN_READWRITE',
    'DISPID_SRGCommit', 'SpeechAllElements', 'SPLOADOPTIONS',
    'ISpeechRecoResultTimes', 'SPPS_RESERVED1',
    'DISPID_SpeechLexiconProns', 'ISpeechTextSelectionInformation',
    'SASPause', 'SBONone', 'SGRSTTEpsilon', 'DISPID_SPRFirstElement',
    'SPDKL_LocalMachine', 'SRTReSent', 'DISPID_SRGRules',
    'DISPID_SAEventHandle', 'DISPID_SRCESoundEnd',
    'DISPID_SGRSAddSpecialTransition', 'SpeechAudioFormatGUIDWave',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPAsCount',
    'DISPID_SRCCmdMaxAlternates', 'SPCT_SUB_COMMAND',
    'SPEI_PROPERTY_STRING_CHANGE', 'SRERequestUI',
    'SPEI_INTERFERENCE', 'SPAR_Medium', 'SPBOOKMARKOPTIONS',
    ...
    'DISPID_SVAlertBoundary', 'SVSFNLPSpeakPunc', 'SPVPRI_NORMAL',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SMSALineId',
    'DISPID_SFSClose', 'ISpeechAudioStatus', 'DISPID_SABIEventBias',
    'DISPID_SVDisplayUI', 'SECHighConfidence', 'SPSEMANTICFORMAT',
    'DISPID_SVVoice', 'DISPID_SGRSTransitions', 'SVP_12',
    'DISPID_SRGCmdLoadFromObject', 'SPGS_EXCLUSIVE',
    'SPWORDPRONUNCIATION', 'ISpeechRecoResultDispatch',
    'DISPID_SVIsUISupported', 'ISpeechFileStream', 'DISPID_SPRText',
    'SINoSignal', 'SpeechVoiceEvents', 'SpeechDataKeyLocation',
    'SVSFNLPMask', 'ISpeechRecoResult2', 'SP_VISEME_0', 'SP_VISEME_1',
    ...
    'DISPID_SRSetPropertyString', 'DISPID_SPCLangId',
    ...
    'DISPID_SRCEventInterests', 'SPSLMA', 'SPXRO_SML',
    'SAFT48kHz8BitMono', 'ISpEventSink', 'SPLO_STATIC',
    'DISPID_SpeechPhraseRules', 'SpResourceManager',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechAudioFormat',
    'SPEI_TTS_BOOKMARK', 'SAFTADPCM_8kHzStereo', 'SGDSActive',
    'SpeechUserTraining', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SVRate', 'SRATopLevel',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SLWs_NewEnum', 'STSF_FlagCreate', 'ISpeechGrammarRule',
    'DISPID_SRCEAdaptation', 'DISPID_SRGDictationSetState',
    'DISPID_SAFGuid', 'DISPID_SMSAMMHandle',
    'DISPID_SREmulateRecognition', 'DISPID_SRCVoice',
    'DISPID_SRCEStartStream', 'SVP_3', 'DISPID_SpeechLexicon',
    'SpUnCompressedLexicon', 'SPPARTOFSPEECH', 'IEnumSpObjectTokens',
    'DISPID_SPPsCount', 'DISPID_SLPType', 'WAVEFORMATEX',
    'SAFT8kHz8BitMono', 'Speech_Default_Weight', 'DISPID_SRGetFormat',
    'SpeechRunState', 'SpInProcRecoContext',
    'DISPID_SpeechWaveFormatEx', 'SAFTGSM610_8kHzMono',
    'eLEXTYPE_RESERVED9', 'SP_VISEME_8', 'SPAUDIOSTATE',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SpeechFileStream',
    'eLEXTYPE_PRIVATE14', 'DISPID_SABufferInfo', 'SPWF_SRENGINE',
    'DISPID_SPRNumberOfElements', 'SpInprocRecognizer',
    'DISPID_SRCPause', 'SASRun', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPIElements', 'SPLO_DYNAMIC', 'SRCS_Enabled',
    'SRSActiveAlways', 'ISpeechRecoResult', 'SASClosed',
    'SpeechCategoryRecoProfiles', 'DISPID_SVSPhonemeId',
    'SPCT_SUB_DICTATION', 'ISpeechPhraseElement',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPIGetText',
    'SAFTCCITT_uLaw_8kHzStereo', 'SLTApp', 'SVF_Stressed',
    'SGSDisabled', 'SPADAPTATIONRELEVANCE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRSAudioStatus',
    'SPEI_MIN_SR', 'ISpeechMMSysAudio', 'SPINTERFERENCE_TOOQUIET',
    'SPEI_PHRASE_START', 'SDTPronunciation', 'DISPID_SRRecognizer',
    'SAFTExtendedAudioFormat', 'DISPID_SVSLastResult',
    'DISPID_SASState', 'DISPID_SRSetPropertyNumber', 'SVEPhoneme',
    'SECNormalConfidence', 'DISPID_SASFreeBufferSpace',
    'SAFT24kHz16BitMono', 'DISPID_SPPs_NewEnum',
    'DISPID_SVEEnginePrivate', 'DISPID_SVSVisemeId',
    'SpeechSpecialTransitionType', 'SITooLoud',
    'SpNullPhoneConverter', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechMemoryStream', 'SSTTDictation', 'DISPID_SRState',
    'SVP_10', 'SPXRO_Alternates_SML', 'ISpResourceManager',
    'SAFTADPCM_44kHzStereo', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SpeechObjectToken', 'DISPID_SGRsCount',
    'ISpeechObjectTokenCategory', 'STSF_CommonAppData',
    'SVEAudioLevel', '_SPAUDIOSTATE', 'SpeechCategoryAudioIn',
    'ISpObjectToken', '_RemotableHandle', 'DISPID_SVVolume',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'eLEXTYPE_USER_SHORTCUT',
    'SREStreamStart', 'DISPID_SRGRecoContext',
    'DISPIDSPTSI_ActiveOffset', 'SPAUDIOBUFFERINFO', 'SVPNormal',
    'SPRECOGNIZERSTATUS', 'ISpAudio', 'SRSInactiveWithPurge',
    'SDTLexicalForm', 'SVP_20', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRRTTickCount', 'DISPID_SRCSetAdaptationData',
    'DISPID_SWFEChannels', 'SPSNotOverriden',
    'ISpeechPhraseReplacement', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFT11kHz16BitMono', 'SVSFPurgeBeforeSpeak', 'DISPID_SGRSRule',
    'SVP_2', 'ISpNotifySource', 'ISpDataKey', 'SP_VISEME_4',
    'SPINTERFERENCE_NOISE', 'DISPID_SWFEExtraData',
    'SAFT24kHz8BitMono', 'SAFTCCITT_uLaw_22kHzMono', 'SLTUser',
    'SITooQuiet', 'ISpeechPhraseInfo',
    'ISpeechGrammarRuleStateTransitions', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SPEsItem', 'DISPID_SGRSTPropertyId', 'DISPID_SRGId',
    'ISpXMLRecoResult', 'DISPID_SpeechRecognizerStatus',
    'SVEWordBoundary', 'SREInterference', 'DISPID_SRIsUISupported',
    'SRADefaultToActive', 'DISPID_SMSADeviceId', 'DISPIDSPRG',
    'SRTStandard', 'SVP_16', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPAUDIOOPTIONS', 'SpeechAudioState', 'SAFTADPCM_44kHzMono',
    'DISPID_SPANumberOfElementsInResult', 'SGRSTTTextBuffer',
    'SAFT24kHz8BitStereo', 'SAFT44kHz8BitStereo', 'SPWORDLIST',
    'ISpeechCustomStream', 'DISPID_SPPChildren', 'ISpRecoContext2',
    'DISPID_SBSFormat', 'DISPID_SOTRemoveStorageFileName',
    'SPWORDPRONOUNCEABLE', 'eLEXTYPE_RESERVED4', 'SINone',
    'SPWF_INPUT', 'SRAORetainAudio', 'SpeechAudioFormatGUIDText',
    'SP_VISEME_6', 'DISPID_SVAudioOutputStream',
    'DISPID_SOTCEnumerateTokens', 'SPEI_VISEME',
    'DISPID_SRCEEnginePrivate', 'SpShortcut', 'IStream',
    '__MIDL_IWinTypes_0009', 'DISPID_SRGDictationUnload',
    'SAFT32kHz8BitStereo', 'SpeechFormatType', 'DISPID_SBSRead',
    'DISPID_SRSClsidEngine', 'DISPID_SWFESamplesPerSec',
    'SPGS_ENABLED', 'SPEVENT', 'ISpeechPhraseElements',
    'SpeechTokenKeyUI', 'DISPID_SRGCmdLoadFromResource', 'SGRSTTWord',
    'SGRSTTRule', 'tagSTATSTG', 'DISPID_SPEsCount', 'SPEI_SR_PRIVATE',
    'DISPID_SPRuleChildren', 'ISpeechRecoGrammar', 'DISPID_SPRsItem',
    'SAFTADPCM_8kHzMono', 'STCInprocHandler', 'SVSFVoiceMask',
    'SAFT8kHz8BitStereo', 'SAFT16kHz8BitMono',
    'DISPID_SDKGetBinaryValue', 'SRARoot', 'SPCATEGORYTYPE',
    'DISPID_SVSpeak', 'SDTAll', 'DISPID_SPRuleParent', 'SPBO_PAUSE',
    'SAFT8kHz16BitMono', 'DISPID_SBSWrite',
    'DISPID_SABIMinNotification', 'SVSFUnusedFlags', 'SSTTTextBuffer',
    'DISPID_SGRClear', 'SPEI_TTS_PRIVATE', 'DISPID_SVEventInterests',
    'SREPropertyStringChange', 'SP_VISEME_2', 'ISpeechBaseStream',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechObjectTokens', 'DISPID_SDKDeleteKey',
    'eLEXTYPE_PRIVATE1', 'SPEI_SOUND_START', 'SRESoundStart',
    'SPRST_NUM_STATES', 'SpeechDiscardType', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechPhraseReplacements',
    'DISPID_SVSInputSentenceLength', 'SWPUnknownWordUnpronounceable',
    'DISPID_SGRAttributes', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SGRSTText', 'SVEEndInputStream',
    'SpeechPropertyComplexResponseSpeed', 'SASStop', 'SDTRule',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SLGetWords', 'SVP_0',
    'SPPS_SuppressWord', 'SPEI_MIN_TTS', 'SPPROPERTYINFO',
    'DISPID_SVSInputSentencePosition', 'DISPID_SLPLangId',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SGRSTs_NewEnum',
    'SPEI_RESERVED6', 'SBOPause', 'SPEI_MAX_SR',
    'DISPID_SPAs_NewEnum', 'DISPIDSPTSI_ActiveLength', 'DISPID_SGRId',
    'DISPID_SRRRecoContext', 'DISPID_SOTRemove',
    'SpeechDisplayAttributes', 'ISpeechPhraseProperty',
    'eLEXTYPE_RESERVED7', 'DISPID_SpeechVoiceEvent', 'SP_VISEME_20',
    'SWPKnownWordPronounceable', 'SPEI_END_INPUT_STREAM',
    'eLEXTYPE_RESERVED6', 'SpStreamFormatConverter',
    'SpeechPropertyHighConfidenceThreshold', 'SPINTERFERENCE',
    'DISPID_SPAsItem', 'DISPID_SVEAudioLevel',
    'DISPID_SPEAudioStreamOffset', 'SVP_18', 'ISpeechVoice',
    'SPPS_Modifier', 'DISPID_SRGetPropertyString',
    'ISpNotifyTranslator', 'SPSHT_NotOverriden', 'eLEXTYPE_PRIVATE10',
    'DISPID_SpeechPhraseAlternate', 'SECFIgnoreCase',
    'DISPID_SVGetProfiles', 'ISpRecoContext', 'DISPID_SVPause',
    'DISPID_SOTsItem', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SVEPhoneme',
    'SAFTGSM610_44kHzMono', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPPEngineConfidence',
    'DISPID_SRRSpeakAudio', 'ISpeechRecoContext',
    'DISPID_SGRSTsCount', 'DISPID_SLWLangId', 'DISPID_SpeechAudio',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPAStartElementInResult',
    'SPEI_RECO_STATE_CHANGE', 'ISpeechPhraseAlternate',
    'SpeechEngineConfidence', 'DISPID_SRCERequestUI',
    'SPPS_RESERVED3', 'SPEI_SENTENCE_BOUNDARY', 'SVP_5',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVSRunningState',
    'SAFTCCITT_uLaw_11kHzStereo', 'SGDSInactive',
    'DISPID_SPEAudioSizeTime', 'DISPID_SOTCGetDataKey',
    'SDKLLocalMachine', 'ISequentialStream',
    'SpeechCategoryAppLexicons', 'SAFTNonStandardFormat',
    'ISpPhoneticAlphabetSelection', 'DISPID_SOTId', 'SPLEXICONTYPE',
    'SAFT16kHz8BitStereo', 'DISPID_SRCEPhraseStart',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPCPhoneToId',
    'ISpeechLexiconPronunciations', 'SPRS_INACTIVE',
    'SPEVENTSOURCEINFO', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SASetState', 'SVP_17', 'SPPS_NotOverriden',
    'DISPID_SPRuleName', 'ISpeechLexiconWords', 'SpeechVisemeFeature',
    'DISPID_SRGDictationLoad', 'DISPID_SRRAlternates',
    'ISpeechDataKey', 'SVP_11', 'SGSExclusive', 'SPAR_Unknown',
    'SpeechPropertyResourceUsage', 'SPRS_ACTIVE_USER_DELIMITED',
    'IInternetSecurityManager', 'IInternetSecurityMgrSite',
    'ISpeechPhraseInfoBuilder', 'SVP_21', 'DISPID_SPPId',
    'eLEXTYPE_PRIVATE5', 'SP_VISEME_16', 'STCRemoteServer',
    'SVESentenceBoundary', 'DISPID_SVSLastStreamNumberQueued',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRStatus', 'SPVOICESTATUS',
    'DISPID_SWFEBitsPerSample', 'SPEVENTENUM',
    'ISpStreamFormatConverter', 'STCInprocServer', 'SDTReplacement',
    'SPDKL_CurrentConfig', 'SPSModifier', 'DISPID_SGRsItem',
    'SPSUnknown', 'SAFTCCITT_ALaw_8kHzStereo', 'SINoise',
    'ISpeechPhraseAlternates', 'SGRSTTWildcard', 'SpeechWordType',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SGRSAddWordTransition',
    'SPEI_END_SR_STREAM', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechMMSysAudio', 'DISPID_SDKGetlongValue',
    'DISPID_SWFEBlockAlign', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SVSFIsFilename', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRCERecognition', 'SAFT12kHz8BitMono',
    'SPEI_VOICE_CHANGE', 'SREStateChange', 'eLEXTYPE_APP',
    'eLEXTYPE_PRIVATE7', 'ISpProperties',
    'SDA_Consume_Leading_Spaces', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechPhraseElements',
    'SVPOver', 'SPEI_PHONEME', 'DISPID_SPRulesCount',
    'eLEXTYPE_PRIVATE8', 'DISPID_SpeechGrammarRuleState',
    'SPSHT_EMAIL', 'tagSPTEXTSELECTIONINFO', 'eLEXTYPE_PRIVATE19',
    'ISpeechGrammarRuleStateTransition', 'SREAdaptation',
    'DISPID_SpeechPhoneConverter', 'DISPID_SAVolume', 'SECFDefault',
    'SPAS_STOP', 'ISpeechXMLRecoResult', 'DISPID_SPIEngineId',
    'SVSFDefault', 'DISPID_SRCResume', 'DISPID_SLGenerationId',
    'DISPID_SRRTOffsetFromStart', 'ISpeechWaveFormatEx',
    'ISpeechLexiconWord', 'ISpeechAudioFormat',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SVEViseme', 'SPSVerb',
    'SREPrivate', 'SPEI_RECOGNITION', 'SAFT22kHz8BitStereo',
    'SGSEnabled', 'DISPID_SPACommit', 'DISPID_SVEBookmark',
    'DISPID_SLRemovePronunciation', 'SPINTERFERENCE_LATENCY_WARNING',
    'SP_VISEME_13', 'ISpObjectTokenCategory',
    'DISPID_SLAddPronunciation', 'SRERecoOtherContext', 'SFTSREngine',
    'SpeechCategoryAudioOut', 'SPAS_RUN', 'SPPS_Interjection',
    'SAFTADPCM_11kHzMono', 'SPPS_RESERVED2',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpeechResourceLoader',
    'ISpStreamFormat', 'DISPID_SPEPronunciation',
    'DISPID_SRCRequestedUIType', 'DISPIDSPTSI_SelectionOffset',
    'eLEXTYPE_PRIVATE17', 'DISPID_SOTDataKey', 'SPEI_RESERVED1',
    'SREPropertyNumChange', 'SREAudioLevel', 'DISPID_SLPSymbolic',
    'DISPID_SpeechRecoResult', 'ISpeechVoiceStatus',
    'DISPID_SRRGetXMLResult', 'SRAImport', 'SAFT48kHz16BitStereo',
    'SAFTCCITT_ALaw_8kHzMono', 'SVP_8', 'SpWaveFormatEx',
    'ISpObjectWithToken', 'DISPID_SRSSupportedLanguages',
    'SAFT44kHz8BitMono', 'SPWT_DISPLAY',
    'DISPID_SRRDiscardResultInfo', 'SpPhraseInfoBuilder',
    'SPSHT_Unknown', 'SWTDeleted', 'SPAR_Low',
    'SSSPTRelativeToCurrentPosition', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPIRule', 'SREPhraseStart', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRsDynamic', 'SVP_14',
    'UINT_PTR', 'SDTAudio', 'SGLexical', 'eLEXTYPE_PRIVATE13',
    'SGPronounciation', 'SpeechCategoryVoices', 'SSFMCreate',
    'ISpeechObjectTokens', 'SVF_None', 'DISPID_SABIBufferSize',
    'SP_VISEME_5', 'SpLexicon', 'SPBO_TIME_UNITS', 'DISPID_SFSOpen',
    'SPBINARYGRAMMAR', 'SREStreamEnd', 'DISPID_SPRDisplayAttributes',
    'DISPID_SpeechRecoResult2', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SOTDisplayUI', 'SDKLCurrentUser', 'SPPHRASEPROPERTY',
    'SPAUDIOSTATUS', 'DISPID_SPRsCount', 'eLEXTYPE_PRIVATE16',
    'SSTTWildcard', 'DISPID_SRRTimes',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPWT_PRONUNCIATION', 'DISPID_SLPsCount',
    'ISpeechPhraseProperties',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SP_VISEME_17',
    'DISPID_SRAudioInputStream', 'SAFTCCITT_ALaw_22kHzMono',
    'SPWT_LEXICAL', 'DISPID_SpeechLexiconWord',
    'DISPID_SRGetPropertyNumber', 'SAFT16kHz16BitStereo',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPXMLRESULTOPTIONS',
    'SpSharedRecoContext', 'DISPID_SPIGrammarId', 'SP_VISEME_12',
    'SAFT22kHz16BitMono', 'DISPID_SVEVoiceChange', 'DISPID_SOTsCount',
    'eLEXTYPE_PRIVATE4', 'SVEBookmark', 'SVF_Emphasis',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRSNumberOfActiveRules',
    'SPEI_UNDEFINED', 'SREFalseRecognition', 'DISPID_SVPriority',
    'SPSFunction', 'DISPID_SRCEBookmark',
    'SpeechPropertyResponseSpeed', 'SVEAllEvents',
    'ISpeechRecognizer', 'SLODynamic', 'SP_VISEME_15',
    'SDA_No_Trailing_Space', 'SpeechRecoEvents', 'SPAO_NONE',
    'ISpeechAudioBufferInfo', 'SAFT12kHz16BitStereo', 'ISpMMSysAudio',
    'DISPID_SAFGetWaveFormatEx', 'ISpGrammarBuilder',
    'eLEXTYPE_PRIVATE12', 'DISPID_SDKGetStringValue',
    'DISPID_SLPs_NewEnum', 'DISPID_SVGetAudioOutputs', 'SPPS_Verb',
    'SVSFlagsAsync', 'IEnumString', 'SVSFIsXML', 'STSF_LocalAppData',
    'DISPID_SPPName', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SPRuleFirstElement', 'DISPID_SRCEPropertyNumberChange',
    'eLEXTYPE_VENDORLEXICON', 'ISpPhoneticAlphabetConverter',
    'SPPHRASEREPLACEMENT', 'DISPID_SGRSTRule',
    'DISPID_SDKSetStringValue', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SVSInputWordLength', 'SPFM_NUM_MODES',
    'eLEXTYPE_RESERVED10', 'DISPID_SRCEInterference',
    'SPRST_INACTIVE', 'SpeechVoiceSkipTypeSentence', 'SPPHRASE',
    'DISPID_SVEWord', 'DISPID_SGRName', 'SPEI_PROPERTY_NUM_CHANGE',
    'SAFT48kHz16BitMono', 'SPTEXTSELECTIONINFO', 'DISPID_SGRsCommit',
    'SPEI_RESERVED2', 'SRAExport', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRRTLength', 'SPEI_REQUEST_UI', 'SpeechAudioVolume',
    'SPFM_CREATE_ALWAYS', 'SPDKL_CurrentUser',
    'DISPID_SRCEPropertyStringChange', 'eLEXTYPE_USER',
    'SAFTCCITT_ALaw_11kHzMono', 'SPGS_DISABLED',
    'ISpeechPhoneConverter', 'DISPID_SRAudioInput', 'SVP_4',
    'SPCS_DISABLED', 'SpeechBookmarkOptions',
    'DISPID_SPEAudioSizeBytes', 'SPSInterjection',
    'DISPID_SDKSetLongValue', 'SpeechTokenKeyFiles',
    'Speech_StreamPos_RealTime',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRCRetainedAudio', 'DISPID_SGRsCommitAndSave',
    'DISPID_SOTCId', 'SpMMAudioEnum', 'DISPID_SGRsAdd',
    'SPPS_Function', 'SPRST_INACTIVE_WITH_PURGE', 'SPRULE',
    'DISPID_SPPValue', 'DISPID_SOTGetAttribute',
    'DISPID_SRCEHypothesis', 'SPEI_ADAPTATION', 'SECFEmulateResult',
    'SPEI_RESERVED3', 'SAFT32kHz8BitMono', 'SpeechGrammarTagWildcard',
    'SPINTERFERENCE_TOOFAST', 'ISpRecoResult',
    'DISPID_SGRSTPropertyName', 'DISPID_SPERequiredConfidence',
    'DISPID_SDKSetBinaryValue', 'SP_VISEME_11',
    'DISPID_SPRuleEngineConfidence', 'SPSHORTCUTTYPE',
    'DISPIDSPTSI_SelectionLength', 'SpFileStream',
    'SpeechPartOfSpeech', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SLWsCount', 'DISPID_SABufferNotifySize',
    'DISPID_SRCAudioInInterferenceStatus',
    'ISpeechPhraseReplacements', 'DISPID_SPEActualConfidence',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRCCreateGrammar',
    'ISpeechObjectToken', 'SVP_6', 'SAFT22kHz16BitStereo',
    'SPEI_SR_AUDIO_LEVEL', 'SAFTCCITT_uLaw_11kHzMono',
    'SpMemoryStream', 'SpeechTokenIdUserLexicon',
    'eLEXTYPE_PRIVATE11', 'SWPUnknownWordPronounceable', 'SPPS_LMA',
    'SPAO_RETAIN_AUDIO', 'SECFIgnoreWidth', 'SECFNoSpecialChars',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRRSaveToMemory',
    'DISPID_SRSCurrentStreamNumber', 'SpeechGrammarWordType',
    'ISpRecognizer', 'SVP_15', 'ISpShortcut',
    'SPINTERFERENCE_NOSIGNAL', '_ISpeechVoiceEvents',
    'SSFMOpenForRead', 'SP_VISEME_9', 'DISPID_SRCState',
    'SPRULESTATE', 'DISPID_SPIReplacements', 'SPINTERFERENCE_TOOLOUD',
    'SpeechRecoProfileProperties', 'SPAS_CLOSED',
    'DISPID_SpeechPhraseInfo', 'SRAONone', 'SAFT12kHz8BitStereo',
    'SAFTText', 'SFTInput', 'SPWORD', 'SpeechMicTraining',
    'ISpRecoGrammar2', 'SPSEMANTICERRORINFO', 'SPSHORTCUTPAIR',
    'SPEI_START_INPUT_STREAM', 'eLEXTYPE_PRIVATE9',
    'SpeechAudioProperties', 'SpVoice', 'SpeechTokenValueCLSID',
    'SPVISEMES', 'DISPID_SPPNumberOfElements', 'SDKLCurrentConfig',
    'ISpVoice', 'DISPID_SGRSTsItem', 'DISPID_SpeechPhraseAlternates',
    'SAFTCCITT_ALaw_11kHzStereo', 'SWTAdded', 'SPINTERFERENCE_NONE',
    'SAFTGSM610_11kHzMono', 'ISpeechLexiconPronunciation',
    'SRSInactive', 'DISPID_SBSSeek', 'SpMMAudioOut',
    'SDKLDefaultLocation', 'SRSActive', 'SRTExtendableParse',
    'DISPID_SRCESoundStart', 'SDTDisplayText', 'DISPID_SRDisplayUI',
    'DISPID_SMSGetData', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT44kHz16BitStereo',
    'DISPID_SGRInitialState', 'SSFMCreateForWrite',
    'eLEXTYPE_PRIVATE20', 'SPFM_CREATE', 'SAFTADPCM_22kHzMono',
    'DISPID_SRRAudio', 'DISPID_SOTSetId', 'DISPID_SpeechGrammarRules',
    'DISPID_SAFType', 'SpeechLexiconType', 'SPWORDTYPE',
    'DISPID_SRProfile', 'SPGRAMMARWORDTYPE', 'DISPID_SRCEEndStream',
    'DISPID_SRGSetTextSelection', 'SREHypothesis', 'SGRSTTDictation',
    'DISPID_SPRs_NewEnum', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'Speech_Max_Word_Length', 'DISPID_SGRAddResource',
    'SGDSActiveWithAutoPause', 'eLEXTYPE_PRIVATE18',
    'DISPID_SMSSetData', 'SRCS_Disabled', 'SpeechRecognizerState',
    'SpCustomStream', 'SVP_19', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SVSpeakStream', 'DISPID_SVESentenceBoundary',
    'SPCT_SLEEP', 'DISPID_SpeechBaseStream', 'DISPID_SPPParent',
    'SAFT48kHz8BitStereo', 'SpeechCategoryRecognizers',
    'SVSFParseSsml', 'SP_VISEME_3', 'SPPS_Noun', 'DISPID_SOTCSetId',
    'DISPID_SVEStreamStart', 'ISpeechGrammarRules',
    'SAFTNoAssignedFormat', 'DISPID_SPILanguageId',
    'DISPID_SVSLastBookmark', 'DISPID_SGRAddState',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPCIdToPhone',
    'SGLexicalNoSpecialChars', 'DISPID_SLWWord',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SVResume',
    'SpeechVisemeType', 'SPAS_PAUSE', 'tagSPPROPERTYINFO',
    'ISpeechRecognizerStatus', 'SPEI_HYPOTHESIS', 'DISPID_SVSkip',
    'SAFTGSM610_22kHzMono', 'SpeechRegistryLocalMachineRoot',
    'SVSFPersistXML', 'SDTAlternates', 'ISpRecognizer2',
    'DISPID_SpeechRecoContext', 'ISpeechMemoryStream',
    'SpPhoneConverter', 'SPSSuppressWord', 'eWORDTYPE_DELETED',
    'SPGRAMMARSTATE', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRGetRecognizers', 'SpTextSelectionInformation',
    'DISPID_SpeechCustomStream', 'SVSFParseAutodetect',
    'SPWORDPRONUNCIATIONLIST', 'SP_VISEME_10', 'SPEI_SOUND_END',
    'SVSFParseMask', 'SPRST_ACTIVE', 'SRSEDone', 'ISpRecoGrammar',
    'DISPID_SOTs_NewEnum', 'SAFTDefault', 'DISPID_SPRuleId',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SGDisplay',
    'SpeechRetainedAudioOptions', 'DISPID_SASCurrentDevicePosition',
    'SPSERIALIZEDRESULT', 'ISpRecognizer3', 'STCLocalServer',
    'DISPID_SPERetainedSizeBytes', 'SVSFIsNotXML',
    'SpSharedRecognizer', 'SPCS_ENABLED', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRRAudioFormat', 'DISPID_SpeechObjectTokenCategory',
    'SPSNoun', 'SAFTCCITT_uLaw_44kHzMono', 'SpeechWordPronounceable',
    'DISPID_SRCreateRecoContext', 'Speech_StreamPos_Asap',
    'DISPID_SPAPhraseInfo', 'ISpeechAudio', 'SPAR_High',
    'DISPID_SRRGetXMLErrorInfo', 'SpCompressedLexicon',
    'DISPID_SpeechPhraseProperties', 'SVPAlert',
    'DISPID_SRRPhraseInfo', 'SPPHRASERULE',
    'DISPID_SPERetainedStreamOffset', 'SAFTADPCM_11kHzStereo',
    'DISPID_SPIStartTime', 'DISPID_SVSpeakCompleteEvent',
    'SpeechVoicePriority', 'SRERecognition',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRCRecognizer',
    'ISpeechPhraseRule', 'DISPID_SLWType', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SVAudioOutput', 'SPEI_SR_RETAINEDAUDIO',
    'SAFT32kHz16BitStereo', 'DISPID_SpeechPhraseRule',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPPConfidence',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPEs_NewEnum',
    'DISPID_SPRules_NewEnum', 'DISPID_SVGetVoices',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SSSPTRelativeToStart', 'DISPID_SADefaultFormat',
    'SpeechGrammarState', 'SRADynamic', 'ISpEventSource',
    'DISPID_SPRuleConfidence', 'SITooSlow', 'DISPID_SPARecoResult',
    'ISpSerializeState', 'SSSPTRelativeToEnd', 'SPCT_DICTATION',
    'SPFM_OPEN_READONLY', 'DISPID_SLWPronunciations', 'SRTEmulated',
    'SpeechRecoContextState', 'SPEI_MAX_TTS', 'SpeechAddRemoveWord',
    'ISpLexicon', 'SPSMF_UPS', 'SpeechRecognitionType',
    'SpeechLoadOption', 'SECFIgnoreKanaType', 'DISPID_SAStatus',
    'DISPID_SPPFirstElement', 'SVEStartInputStream',
    'DISPID_SpeechLexiconWords', 'SAFT24kHz16BitStereo',
    'SVEVoiceChange', 'SVP_13', 'SPPS_Unknown', 'DISPID_SVEStreamEnd',
    'SRTSMLTimeout', 'Speech_Max_Pron_Length', 'DISPID_SCSBaseStream',
    'SAFT11kHz16BitStereo', 'DISPID_SDKOpenKey', 'SAFT11kHz8BitMono',
    'DISPID_SRCBookmark', 'DISPID_SRCEAudioLevel', 'SPVPRI_ALERT',
    'DISPID_SDKEnumValues', 'SPDKL_DefaultLocation',
    'SpNotifyTranslator', 'SPRECOSTATE', 'SpeechGrammarTagDictation',
    'SPSHORTCUTPAIRLIST', 'SP_VISEME_18', 'SPEI_WORD_BOUNDARY',
    'SpeechRuleAttributes', 'SVP_1', 'DISPID_SPPsItem',
    'SpObjectTokenCategory', 'DISPID_SRIsShared', 'SPBO_NONE',
    'SpMMAudioIn', 'SRTAutopause', 'DISPID_SPRulesItem', 'SpStream',
    'DISPID_SpeechDataKey', 'SPSHT_OTHER', 'DISPID_SpeechGrammarRule',
    'DISPID_SPISaveToMemory', 'DISPID_SOTCategory',
    'DISPID_SWFEFormatTag', 'SpeechVoiceSpeakFlags', 'SP_VISEME_21',
    'SVP_9', 'SP_VISEME_14', 'SPVPRI_OVER', 'STSF_AppData',
    'SPWAVEFORMATTYPE', 'SAFTCCITT_uLaw_22kHzStereo', 'SPVPRIORITY',
    'ISpStream', 'DISPID_SRGReset', 'SpeechStreamSeekPositionType',
    'DISPID_SOTIsUISupported', 'SRAInterpreter',
    'DISPID_SVSInputWordPosition', 'DISPID_SASNonBlockingIO',
    'DISPID_SVSCurrentStreamNumber', 'SPSERIALIZEDPHRASE',
    'SECLowConfidence', 'SDTProperty', 'SPDATAKEYLOCATION',
    'eLEXTYPE_PRIVATE3', 'eLEXTYPE_PRIVATE6', 'SPCT_COMMAND',
    'SAFT44kHz16BitMono', 'DISPID_SDKEnumKeys',
    'DISPID_SVWaitUntilDone', 'SAFT11kHz8BitStereo',
    'SPEI_SR_BOOKMARK', 'SpeechInterference', 'SAFT32kHz16BitMono',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SGRs_NewEnum',
    'SPPHRASEELEMENT', 'SVEPrivate', 'eLEXTYPE_PRIVATE15',
    'SLOStatic', 'eLEXTYPE_RESERVED8', 'SPBO_AHEAD',
    'SPRECOCONTEXTSTATUS'
]
